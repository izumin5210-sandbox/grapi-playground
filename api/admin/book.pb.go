...
package admin_pb // import "github.com/izumin5210-sandbox/grapi-playground/api/admin"
...
func (*ListBooksRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_6fd13710b0269a8e, []int{0}
}
...
func (*ListBooksResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_6fd13710b0269a8e, []int{1}
}
...
func (*GetBookRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_6fd13710b0269a8e, []int{2}
}
...
func (*CreateBookRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_6fd13710b0269a8e, []int{3}
}
...
func (*UpdateBookRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_6fd13710b0269a8e, []int{4}
}
...
func (*DeleteBookRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_6fd13710b0269a8e, []int{5}
}
...
func init() {
	proto.RegisterType((*ListBooksRequest)(nil), "izumin5210.sandbox.grapi_playground.admin.ListBooksRequest")
	proto.RegisterType((*ListBooksResponse)(nil), "izumin5210.sandbox.grapi_playground.admin.ListBooksResponse")
	proto.RegisterType((*GetBookRequest)(nil), "izumin5210.sandbox.grapi_playground.admin.GetBookRequest")
	proto.RegisterType((*CreateBookRequest)(nil), "izumin5210.sandbox.grapi_playground.admin.CreateBookRequest")
	proto.RegisterType((*UpdateBookRequest)(nil), "izumin5210.sandbox.grapi_playground.admin.UpdateBookRequest")
	proto.RegisterType((*DeleteBookRequest)(nil), "izumin5210.sandbox.grapi_playground.admin.DeleteBookRequest")
}
...
func (c *bookServiceClient) ListBooks(ctx context.Context, in *ListBooksRequest, opts ...grpc.CallOption) (*ListBooksResponse, error) {
	...
	err := grpc.Invoke(ctx, "/izumin5210.sandbox.grapi_playground.admin.BookService/ListBooks", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) GetBook(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*_type.Book, error) {
	out := new(_type.Book)
	err := grpc.Invoke(ctx, "/izumin5210.sandbox.grapi_playground.admin.BookService/GetBook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) CreateBook(ctx context.Context, in *CreateBookRequest, opts ...grpc.CallOption) (*_type.Book, error) {
	out := new(_type.Book)
	err := grpc.Invoke(ctx, "/izumin5210.sandbox.grapi_playground.admin.BookService/CreateBook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) UpdateBook(ctx context.Context, in *UpdateBookRequest, opts ...grpc.CallOption) (*_type.Book, error) {
	out := new(_type.Book)
	err := grpc.Invoke(ctx, "/izumin5210.sandbox.grapi_playground.admin.BookService/UpdateBook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) DeleteBook(ctx context.Context, in *DeleteBookRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := grpc.Invoke(ctx, "/izumin5210.sandbox.grapi_playground.admin.BookService/DeleteBook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BookService_ListBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/izumin5210.sandbox.grapi_playground.admin.BookService/ListBooks",
	}
...
func _BookService_GetBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/izumin5210.sandbox.grapi_playground.admin.BookService/GetBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookService_CreateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/izumin5210.sandbox.grapi_playground.admin.BookService/CreateBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookService_UpdateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/izumin5210.sandbox.grapi_playground.admin.BookService/UpdateBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookService_DeleteBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/izumin5210.sandbox.grapi_playground.admin.BookService/DeleteBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BookService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "izumin5210.sandbox.grapi_playground.admin.BookService",
...
func init() { proto.RegisterFile("book.proto", fileDescriptor_book_6fd13710b0269a8e) }

var fileDescriptor_book_6fd13710b0269a8e = []byte{
	// 468 bytes of a gzipped FileDescriptorProto
	,
}
